...
description: Review proposed repo changes or research plans for safety, legality, and bounty-program boundaries. Use before committing agent prompts, scripts, or new research procedures.
